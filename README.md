...
- Solution URL: [Frontend Mentor Submitted Solution](https://www.frontendmentor.io/solutions/qr-code-component-challenge-O3tK3l7gkZ)
...
I will certainly be focusing on responsive design, and looking to strengthen my flexbox application and ensure that I can create layouts that are consistent and congruent in presentation across all screen sizes through additional techniques using media queries to achieve optimal adjustable images, header, footers and font sizes that are adaptable to the screen size it is displayed on. As I do struggle with flexbox application when it comes to adding header and footer and wanting to ensure that the main doesn't overflow onto the footer or the main hiding under the header.
